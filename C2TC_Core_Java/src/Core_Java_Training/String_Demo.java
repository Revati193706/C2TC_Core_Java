...
public class String_Demo {
 ...
 String s=new String ("Revati");

/*  s.concat("Natekar"); // objects are Immutable does not change value.
...
System.out.println(s.replace("Revati", "Reva")); //Replace Revati with Reva

System.out.println(s.equalsIgnoreCase("Revati")); */
